...
python cnn-experiment.py -m lenet -i xn -n bn -c n --numeric --summary --loss
python cnn-experiment.py -m lenet -i xn -n ln -c n --numeric --summary --loss
python cnn-experiment.py -m lenet -i xn -n gn -c n --numeric --summary --loss
python cnn-experiment.py -m lenet -i xn -n nn -c n --numeric --summary --loss
python cnn-experiment.py -m vgg -i xn -n bn -c n --numeric --summary --loss
python cnn-experiment.py -m vgg -i xn -n ln -c n --numeric --summary --loss
python cnn-experiment.py -m vgg -i xn -n gn -c n --numeric --summary --loss
python cnn-experiment.py -m vgg -i xn -n nn -c n --numeric --summary --loss
